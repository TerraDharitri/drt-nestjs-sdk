...
describe('Address utils', () => {
  ...
  it('Convert from Hex address to bech32', () => {
    expect(AddressUtils.bech32Encode('233300000000000000000000000000000002333000000000000000000001ffff')).toStrictEqual('drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqplllsphc9lf');
  });

  it('Convert from bech32 address to hex', () => {
    expect(AddressUtils.bech32Decode('drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqplllsphc9lf')).toStrictEqual('233300000000000000000000000000000002333000000000000000000001ffff');
  });
